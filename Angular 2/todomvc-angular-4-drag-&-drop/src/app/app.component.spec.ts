...
describe('AppComponent', () => {
  ...
  it('should move todo at top to bottom', (done: any) => {
    addTodo({id: 1, title: 'First Todo'});
    addTodo({id: 2, title: 'Second Todo'});
    addTodo({id: 3, title: 'Third Todo'});
  ...
  function triggerEvent(element: HTMLElement, eventName: string, eventType: string) {
